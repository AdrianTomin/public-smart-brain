...
import { useMemoizedParticleBG } from '@/hooks/useMemoizedParticleBG';
...
const Login = (): React.ReactElement => {
	...
	const { setUser, clearUser } = useSetUser();
	...
	return (
		...
		>
			<Head>
				...
				<meta name="description" content="Smart Brain web application login-page to detect the content in pictures" />
